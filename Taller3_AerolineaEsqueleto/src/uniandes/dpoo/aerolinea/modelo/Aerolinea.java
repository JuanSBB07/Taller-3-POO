...
public class Aerolinea
{
    ...
    {
    	List<Tiquete> tiquetesTotales = new ArrayList<Tiquete>( );
        for ( Vuelo vuelo : vuelos ) {
    ...
    public void programarVuelo( String fecha, String codigoRuta, String nombreAvion ) throws Exception
    {
        ...
        if ( avionEncontrado == null ) {
            throw new Exception( "El avión " + nombreAvion + " no está registrado." );
        }
        ...
        Vuelo nuevoVuelo = new Vuelo( ruta, fecha, avionEncontrado );
    ...
    public int venderTiquetes( String identificadorCliente, String fecha, String codigoRuta, int cantidad ) throws VueloSobrevendidoException, Exception
    {
        ...
        if ( vuelo == null ) {
            throw new Exception( "El vuelo especificado no existe." );
        }
    ...
    public String consultarSaldoPendienteCliente( String identificadorCliente )
    {
    	Cliente cliente = getCliente( identificadorCliente );
        if ( cliente == null ) {
            return "El cliente con id " + identificadorCliente + " no existe.";
        }
    ...
    public Aeropuerto getAeropuerto(String codigoAeropuerto) {
        return aeropuertos.get(codigoAeropuerto);
    }
    ...
    {
        return this.aeropuertos.values( );
    }
}
